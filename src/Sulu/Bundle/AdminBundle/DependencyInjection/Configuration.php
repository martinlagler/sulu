        ...
        $treeBuilder->getRootNode()
            ->children()
                ...
                ->arrayNode('field_type_options')
                    ->children()
                        ->arrayNode('grouped_selection')
                            ->useAttributeAsKey('name')
                            ->prototype('array')
                                ->children()
                                    ->scalarNode('resource_key')->isRequired()->end()
                                    ->scalarNode('list_key')->isRequired()->end()
                                    ->scalarNode('adapter')->isRequired()->end()
                                    ->scalarNode('overlay_title')->isRequired()->end()
                                    ->scalarNode('display_property')->isRequired()->end()
                                    ->scalarNode('display_title')->defaultValue('sulu_admin.name')->end()
                                    ->scalarNode('group_id_property')->isRequired()->end()
                                    ->scalarNode('group_label_property')->isRequired()->end()
                                    ->scalarNode('item_count_label')
                                        ->defaultValue('sulu_admin.grouped_selection_item_count')
                                    ->end()
                                    ->arrayNode('columns')
                                        ->isRequired()
